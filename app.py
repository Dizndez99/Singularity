...
ZEN_SYMBOL = Fore.YELLOW + "SFI" + Style.RESET_ALL
...
RPC_URL = os.getenv('RPC_URL', "https://rpc-testnet.singularityfinance.ai")
CHAIN_ID = 751
...
def check_connection():
    if web3.is_connected():
        print(Fore.GREEN + f"Terkoneksi dengan jaringan Singularity Finance Testnet {CHECK_MARK}")
        return True
    else:
        print(Fore.RED + f"Gagal terhubung ke jaringan Singularity Finance Testnet {CROSS_MARK}")
        return False
